...
Notice that the ``other'' group represents the largest slice in the pie chart, indicating that the vast majority of usernames are not in the primary data series.

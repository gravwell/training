...
We will use the
\code{grep}\footnote{Gravwell's ``grep'' module behaves much like the Unix tool of the same name: it searches text for patterns the user specifies. See https://docs.gravwell.io/\#!search/grep/grep.md for more information.} module

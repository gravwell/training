...
\begin{figure}
	\includegraphics[width=0.9\linewidth]{images/account-prefs.png}
...
\begin{figure}
	\includegraphics[width=0.6\linewidth]{images/interface-prefs.png}
...
\begin{figure}
	\includegraphics[width=0.6\linewidth]{images/general-prefs.png}
...
\begin{figure}
	\includegraphics[width=0.6\linewidth]{images/email-prefs.png}
...
\begin{figure}
	\includegraphics[width=0.8\linewidth]{images/filters-menu.png}
	\caption{The filters menu}
	\label{fig:filters-menu}
\end{figure}

\begin{figure}
	\includegraphics[width=0.6\linewidth]{images/filters-options.png}
...
By default, most interfaces will show all objects the user has access to, regardless of owner. Another filter option can make it show only objects owned by a particular set of users. Figure \ref{fig:filter-owner} shows the user filtering macros to show only those macros owned by the user ``John''. Note that the ``My data'' option applies to the current user; selecting this checkbox will show only those items which \emph{belong} to the current user, rather than all items the user \emph{can access}.
